This Python script helps to webscrap the Amazon webpage. It fetches all Products information in the page like Product name, price, product_condition and offers. 
It also inserts those information into MySql database.
...
pymysql - It is used for connecting to MySql and insert the product details into the specified database tables.
